...
export const STUNDE_TEXT = { modus: "stunde1" as "stunde1" | "zaehler", stundeZahl: "1", stundeEinheit: "Std.", stundeGroesse: 1.0, stundeDy: 0.25, stundeEinheitDy: 0.42, stundeImmer: true, stundeX: -0.045,
