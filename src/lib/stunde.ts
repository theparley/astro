...
export const STUNDE_TEXT = { einheit: "Min.", bis: 60, zahlGroesse: 0.9, zahlDy: 0.326, einheitGroesse: 0.14, einheitDy: 0.496, luecke: 0.05 }; // Fred 21.09.: 0,9 / 0,05 („maximal"); luecke in em, zahlDy = Versalhoehe/2
